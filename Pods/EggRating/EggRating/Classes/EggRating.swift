...
//
//https://github.com/naluinui/EGGRating
...
public class EggRating: NSObject {
    ...
    public static var itunesId = "1054792941"
    
    /// The minimum score to bring user to rate on the App Store.
    public static var minRatingToAppStore = 3.5
    ...
    public static var titleLabelText = "Hur många stjärnor? 🇸🇪"
    
    /// The description of EggRatingView.
    public static var descriptionLabelText = "Du kommer att skickas till App Store där du kan skriva din recension (tar ca 30 sekunder). Återvänd sedan till Sverige Spelet för din belöning."
    
    /// The dismiss button title of EggRatingView.
    public static var dismissButtonTitleText = "Avbryt"
    
    /// The rate button title of EggRatingView.
    public static var rateButtonTitleText = "Betygsätt"
    
    /// The thank you title of EggRatingView.
    public static var thankyouTitleLabelText = "Misslyckande"
    
    /// The thank you description of EggRatingView.
    public static var thankyouDescriptionLabelText = "Något gick fel. Försök igen nästa gång."
