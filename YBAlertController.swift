...
// https://github.com/yabuzaki/YBAlertController
...
public class YBAlertController: UIViewController, UIGestureRecognizerDelegate {
    ...
    // background
    public var overlayColor = UIColor(white: 0, alpha: 0.2) //UIColor().SwedenBlue()
    
    // titleLabel
    public var titleFont = UIFont(name: "YanoneKaffeesatz-Bold", size: 28)
    public var titleTextColor = UIColor().SwedenYellow()
    
    // message
    public var message:String?
    public var messageLabel = UILabel()
    public var messageFont = UIFont(name: "YanoneKaffeesatz-Bold", size: 23)
    public var messageTextColor = UIColor().SwedenYellow()
    
    // button
    public var buttonHeight:CGFloat = 50
    public var buttonTextColor = UIColor().SwedenYellow()
    public var buttonIconColor:UIColor?
    public var buttons = [YBButton]()
    public var buttonFont = UIFont(name: "YanoneKaffeesatz-Bold", size: 28)
    
    // cancelButton
    public var cancelButtonTitle:String?
    public var cancelButtonFont = UIFont(name: "YanoneKaffeesatz-Bold", size: 23)
    public var cancelButtonTextColor = UIColor().SwedenYellow()
    ...
    public init() {
        ...
        containerView.backgroundColor = UIColor().SwedenBlue()
        ...
        if style == .ActionSheet {
            UIView.animate(withDuration: 0.2,
                           animations: {
                            ...
                            self.view.backgroundColor = UIColor().SwedenBlue()
    ...
    private func initContainerView() {
        ...
        if let title = title, title != ""  {
            ...
            line.backgroundColor = UIColor().SwedenBlue()
        ...
        if let message = message, message != "" {
            ...
            messageLabel.textColor = UIColor().SwedenYellow()
        ...
        for i in 0..<buttons.count {
            ...
            buttons[i].backgroundColor = UIColor().SwedenBlue()
