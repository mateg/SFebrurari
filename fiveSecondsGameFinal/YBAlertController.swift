...
public class YBAlertController: UIViewController, UIGestureRecognizerDelegate {
    ...
    // titleLabel
    public var titleFont = UIFont(name: "Helvetica-Bold", size: 28)
    public var titleTextColor = UIColor().SwedenYellow()
    
    // message
    public var message:String?
    public var messageLabel = UILabel()
    public var messageFont = UIFont(name: "Helvetica-Bold", size: 23)
    ...
    public var buttonFont = UIFont(name: "Helvetica-Bold", size: 28)
    
    // cancelButton
    public var cancelButtonTitle:String?
    public var cancelButtonFont = UIFont(name: "Helvetica-Bold", size: 23)
