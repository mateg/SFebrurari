...
class StartMenuVC: UIViewController, GADBannerViewDelegate, GADInterstitialDelegate, SwiftShareBubblesDelegate, MFMessageComposeViewControllerDelegate, MFMailComposeViewControllerDelegate, SKProductsRequestDelegate, SKPaymentTransactionObserver, FBSDKLoginButtonDelegate, UIPageViewControllerDataSource  {
    ...
    var FBresult : Any? //FREDRIK //försökte skapa en sätt att skicka vidare "Facebooks user parameterar" (med namn, email etc)... SE grabEmailAddress()
//share bubbles
...
/*UIColor(red: 156/255, green: 39/255, blue: 176/255, alpha: 1.0),
 ...
 UIColor(red: 58/255, green: 255/255, blue: 217/255, alpha: 1.0)*/
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        } else if segue.identifier == "MenuToLeader" {
                if let destination = segue.destination as? LeaderboardVC {
                    
                    destination.FBresult = FBresult
                    //destination.microphoneStatusString = microphoneStatusString
    ...
    func grabEmailAddress() {
        ...
        FBSDKGraphRequest(graphPath: "/me", parameters: ["fields": "id, name, email"]).start {(connection, result, error) in
            ...
            //fbID = result
            // print out the different crediters of the user
            self.FBresult = result
            self.performSegue(withIdentifier: "MenuToLeader", sender: UIButton())
